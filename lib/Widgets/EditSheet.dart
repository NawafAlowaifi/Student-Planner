...
class EditSheet extends StatefulWidget {
  EditSheet(this.index);
  int index;
  @override
  State<EditSheet> createState() => _EditSheetState(index);
}
...
class _EditSheetState extends State<EditSheet> {
  ...
  void _saveForm() {
    ...
    Provider.of<Tasks>(context, listen: false).editTask(index, _editedProduct);
